...
test('startup recovers a damaged score file and preserves its unreadable copy',async()=>{
 ...
 const child=spawn(process.execPath,['--import','tsx','server/index.ts'],{env:{...process.env,ARENA_IGNORE_ENV:'1',YOUTUBE_API_KEYS:'[]',YOUTUBE_CLIENT_ID:'',YOUTUBE_CLIENT_SECRET:'',ARENA_PORT:'4320',ARENA_DATA_DIR:directory},stdio:['ignore','pipe','pipe']});
 try{
