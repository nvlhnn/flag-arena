...
export type ChatBatch={nextPageToken?:string;offlineAt?:string;items?:{id?:string;snippet?:{type?:number;publishedAt?:string;textMessageDetails?:{messageText?:string};superChatDetails?:{amountMicros?:string;currency?:string;userComment?:string}};authorDetails?:{channelId?:string;displayName?:string;profileImageUrl?:string}}[]};
