...
In **Audio > Donation celebrations**, configure English speech, spoken donor names, spoken amounts, visual celebrations, landmarks, volume, and duration (6-15 seconds). Master mute and English announcer settings also apply. Use **Test donation celebration** in an open demo round; previews add no points or donation records. Audio plays in the open OBS overlay; both the studio and overlay show the animation.
